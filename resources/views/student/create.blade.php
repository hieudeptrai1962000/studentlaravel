...
<div class="well">
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                {!! Form::text('full_name', $value = null, ['class' => 'form-control', 'placeholder' => 'Khoa']) !!}
            </div>
        </div>
        <div class="form-group">
            {!! Form::label('email', 'Email:', ['class' => 'col-lg-2 control-label']) !!}
            <div class="col-lg-10">
                {!! Form::text('email', $value = null, ['class' => 'form-control', 'placeholder' => 'Khoa']) !!}
            </div>
        </div>
        <div class="form-group">
            {!! Form::label('birthday', 'Birthday:', ['class' => 'col-lg-2 control-label']) !!}
            <div class="col-lg-10">
                {!! Form::date('birthday', $value = null, ['class' => 'form-control', 'placeholder' => 'Khoa']) !!}
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                {!! Form::text('phone_number', $value = null, ['class' => 'form-control', 'placeholder' => 'Khoa']) !!}
            </div>
        </div>
        <div class="form-group">
            <div class="col-lg-10">
